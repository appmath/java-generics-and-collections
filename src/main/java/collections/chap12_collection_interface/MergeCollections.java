...
public class MergeCollections {
		...
		public static void main(String[] args) {
				TaskCreator taskCreator = TaskCreator.getInstance().addAll();

				Collection<Task> mergedTasks = MergeCollections.merge(taskCreator.getMondayTasks(),
																															taskCreator.getTuesdayTasks());
